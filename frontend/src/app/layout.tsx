          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-6">
                ...
                <a href="/moltbook" className="text-sm text-hive-muted hover:text-hive-text transition-colors flex items-center gap-1">Moltbook<span className="text-[8px]">🦞</span></a>
