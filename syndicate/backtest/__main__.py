"""CLI entry point: python -m syndicate.backtest --start 2025-03-01 --end 2026-03-01 --runs 10"""
...
from syndicate.backtest.engine import BacktestEngine, BacktestConfig
from syndicate.backtest.walk_forward import WalkForwardConfig, WalkForwardOptimizer, WalkForwardResult
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Syndicate Backtester -- walk-forward replay with deterministic signals"
    )
    ...
    if args.fetch_funding or needs_funding:
        from syndicate.data.funding_rates import FundingRateStore as _FRS
