...
from syndicate.data.blockchain import get_btc_onchain_stats
from syndicate.data.coingecko import CoinGeckoClient
from syndicate.data.coinpaprika import CoinPaprikaClient
from syndicate.data.defi_llama import DeFiLlamaClient
from syndicate.data.derivatives import DerivativesClient
from syndicate.data.models import TechnicalIndicators
from syndicate.data.polymarket import PolymarketClient
from syndicate.data.whales import WhaleTracker
...
class DataLayer:
    ...
    def fetch_all(
        ...
        def _enrich_derivatives():
            from syndicate.data.derivatives import has_futures
