"""
Base agent classes for the Syndicate system.
...
from syndicate.config import LLMProvider, OPENAI_COMPAT_BASE_URLS
...
class BaseAgent(BaseLLMCaller, ABC):
    """
    Abstract base for all Syndicate trading analyst agents.
