...
from hivemind.config import LLMProvider, settings
from hivemind.core.encryption import decrypt_api_key
from hivemind.data.models import AgentProfile
...
class AgentRegistry:
    ...
    async def load_all(self) -> None:
        ...
        from hivemind.db.models import AgentRow, AgentStatusDB, TeamRow
    ...
    def instantiate_agent(self, agent_def: AgentDefinition, symbol: str):
        ...
        if agent_def.agent_class and agent_def.agent_class in FOUNDING_AGENT_CLASSES:
            ...
            from hivemind.agents.dynamic import DynamicAgent
    ...
    def get_manager_for_team(
        ...
        if team_name in FOUNDING_MANAGER_CLASSES:
            ...
            from hivemind.agents.dynamic import DynamicTeamManager
