...
from hivemind.api.dependencies import generate_api_token, get_current_contributor
from hivemind.core.cost_estimator import estimate_monthly_cost
from hivemind.core.encryption import encrypt_api_key
from hivemind.db.models import AgentRow, AgentStatusDB, ContributorRow, ProviderType
...
async def register(
    ...
    import asyncio
    from hivemind.board.session import BoardSession
    ...
    return RegisterResponse(
        ...
        message=f"Welcome to Hivemind! {agents_created} agents created. Board will assign them shortly.",
    )
