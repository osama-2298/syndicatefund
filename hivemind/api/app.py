...
from hivemind.api.routes import agents, backtest, ceo_posts, contributors, cycles, portfolio, research, signals, teams
...
async def _daily_research_task(shutdown_event: asyncio.Event):
    ...
    while not shutdown_event.is_set():
        try:
            ...
            from hivemind.research.stats.agent_stats import full_report as agent_full_report
            from hivemind.research.stats.trade_attribution import full_report as trade_full_report
            ...
            from hivemind.research.agents.quant_researcher import QuantResearcher
            from hivemind.config import settings
            ...
            from hivemind.research.agents.strategy_researcher import StrategyResearcher
...
async def _weekly_research_task(shutdown_event: asyncio.Event):
    ...
    while not shutdown_event.is_set():
        try:
            ...
            from hivemind.research.stats.agent_stats import full_report as agent_full_report
            from hivemind.research.stats.trade_attribution import full_report as trade_full_report
            from hivemind.research.stats.data_source_eval import full_report as data_source_full_report
            ...
            from hivemind.research.agents.head_of_research import HeadOfResearch
